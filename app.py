...
#seurat_metadata.rename(columns={'Unnamed: 0':'Id'},inplace=True)
...
pca_all = PCA(n_components = 50).fit(seurat_counts1)
#prepare a scatterplot of genes based on PC1 and PC2
X_pca = pca_all.transform(seurat_counts1)

TSNEdf = pd.DataFrame(TSNE(n_components=3, perplexity=100.0, early_exaggeration=10, n_iter=350,
               n_iter_without_progress = 10, learning_rate=30,
               verbose=0).fit_transform(X_pca), columns = ['TSNE1','TSNE2','TSNE3'])
TSNEdf['Id'] = seurat_counts1.index
TSNEdf['clusters'] = clusters.astype('str')

UMAPdf = pd.DataFrame(umap.UMAP(n_components=3, n_neighbors=10, min_dist=0.2).fit_transform(seurat_counts1), columns = ['UMAP1','UMAP2','UMAP3'])
UMAPdf['Id'] = seurat_counts1.index
UMAPdf['clusters'] = clusters.astype('str')
                ...
                dbc.Col([
                    dbc.Row([
                        dbc.Col([
                            ...
                            dcc.Input(type="number",id="num_of_cluster",value=4,min=0,style={'width':'100%','text-align':'center'})
                        ],width={'size':3,"offset":0,'order':1},style={'text-align':'center','display':'flex'}), #,style={'padding-top' : 10}
                        dbc.Col([
                            html.H6('ID Numbers',style={'padding-top' : 10,'padding-right' : 2}),
                        ],width={'size':3,"offset":0,'order':1},style={'text-align':'center'}),
                        dbc.Col([
                            dcc.Input(type="number",id="num_of_id",value=0,min=0,style={'width':'40%','text-align':'center'}),
                            dcc.Input(type="number",id="num_of_id_2",value=15,min=0,style={'width':'40%','text-align':'center'})
                        ],width={'size':3,"offset":0,'order':1},style={'text-align':'center','display':'flex'}), #,style={'padding-top' : 10}
                        dbc.Col([
                            dbc.Button("Submit", size="sm",className="me-1",id='submit',color="primary")
                        ],width={'size':3,"offset":0,'order':1},style={'text-align':'right'}), #,style={'padding-top' : 10}
                    ])
                ],width={'size':6,"offset":0,'order':1},style={'text-align':'center'}),
                dbc.Col([
                    dbc.Row([
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    html.Span(f"Sample Violin Plot for Samples",style={'text-align':'center'}),
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_3',figure={},style={'height': '350px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_4',figure={},style={'height': '350px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Loading(children=[dcc.Graph(id='bar_chart',figure={},style={'height': '300px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_5',figure={},style={'height': '400px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_6',figure={},style={'height': '400px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_7',figure={},style={'height': '400px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_8',figure={},style={'height': '400px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_9',figure={},style={'height': '500px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
                        ...
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                dbc.Col([
                                    ...
                                    dcc.Loading(children=[dcc.Graph(id='violin_chart_10',figure={},style={'height': '500px'})],color='#119DFF',type='dot'),
                                ],width={'size':12,'offset':0,'order':1},style={'text-align':'center'}),
                            ]),
                        ])
                    ], className='h-100 text-left')
...
def update_scatter_chart(radioitems_input_1,radioitems_input_2,x_axis,y_axis,z_axis):
    if radioitems_input_1 == 'tSNE' and radioitems_input_2 == '2D':
        ...
        figTSNE.write_html('fig_1.html')
        figTSNE.write_image('fig_1.svg')
        ...
        #figTSNE3D.write_html('fig_1.html')
        #figTSNE3D.write_html('fig_1.svg')
        ...
        #figUMAP.write_html('fig_1.html')
        #figUMAP.write_image('fig_1.svg')
        ...
        #figUMAP3D.write_html('fig_1.html')
        #figUMAP3D.write_image('fig_1.svg')
...
def update_violin_chart(selectedData):
    ...
    if selectedData == []:
        ...
        fig.update_layout(template=template,margin=dict(l=0,r=0,t=0,b=0))
    #fig.write_html('violin_chart_1.html')
    #fig.write_image('violin_chart_1.svg')
    return fig
...
def update_violin_chart(gene):
    ...
    #violin_chart_2.write_html('violin_chart_2.html')
    #violin_chart_2.write_image('violin_chart_2.svg')
...
def update_violin_chart(n_clicks,num_of_cluster,num_of_id,num_of_id_2):
    ...
    #violin_chart_3.write_html('violin_chart_3.html')
    #violin_chart_3.write_image('violin_chart_3.svg')
...
def update_violin_chart(gene):
    ...
    #violin_chart_4.write_html('violin_chart_4.html')
    #violin_chart_4.write_image('violin_chart_4.svg')
...
def update_violin_chart(gene):
    ...
    #bar_chart.write_image('bar_chart.svg')
    return bar_chart
...
def update_violin_chart(gene):
    ...
    #fig.write_html('violin_chart_5.html')
    #fig.write_image('violin_chart_5.svg')
...
def update_violin_chart(gene,radioitems_input_3,radioitems_input_4):
    ...
    if radioitems_input_3 == 'UMAP' and radioitems_input_4 == '2D':
        ...
        #figUMAP.write_html('violin_chart_6.html')
        #figUMAP.write_image('violin_chart_6.svg')
...
def update_violin_chart(selected_gene_1,selected_gene_2,selected_gene_3,selected_gene_4):
    ...
    fig.update_layout(xaxis_showgrid=True, xaxis_zeroline=False,
                  template=template)
    #fig.write_html('violin_chart_7.html')
    #fig.write_image('violin_chart_7.svg')
    return fig
...
def update_violin_chart(selected_gene_1,selected_gene_2,selected_gene_3,selected_gene_4):
    ...
    figUMAP3D.update_traces(marker_size = 2)
    #figUMAP3D.write_html('violin_chart_8.html')
    #figUMAP3D.write_image('violin_chart_8.svg')
    return figUMAP3D
...
def update_violin_chart(selected_gene_1,selected_gene_2,selected_gene_3,selected_gene_4):
    ...
    #fig.write_html('violin_chart_9.html')
    #fig.write_image('violin_chart_9.svg')
    return fig
...
def update_violin_chart(selected_gene_1,selected_gene_2,selected_gene_3,selected_gene_4):
    ...
    #fig.write_html('violin_chart_10.html')
    #fig.write_image('violin_chart_10.svg')
    return fig
